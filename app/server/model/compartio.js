...
var compartioSchema = mongoose.Schema({
	...
	giver			: { type: ObjectId, ref: 'person' },
	receiver		: { type: ObjectId, default: null, ref: 'person' },
	i_like_it		: [{ type: ObjectId, ref: 'person' }],
	i_want_it		: [{ type: ObjectId, ref: 'person' }],
	...
	comments		: [{
		user_that_comments	: { type: ObjectId, ref: 'person' },
		i_like_it_comment	: [{ type: ObjectId, ref: 'person' }],
